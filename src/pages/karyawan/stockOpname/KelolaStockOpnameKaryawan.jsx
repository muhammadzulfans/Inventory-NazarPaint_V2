...
import { useStockOpnameCreateKaryawan } from "../../../hooks/karyawan/useStockOpnameCreateKaryawan.js";
...
const KelolaStockOpnameKaryawan = () => {
    ...
    } = useStockOpnameCreateKaryawan();

    return (
        <div className="px-8 pt-6 pb-10 bg-white">
            <div className="mb-14 flex gap-10">
                <div className="flex gap-4">
                    <button onClick={() => navigate("/karyawan/stock-opname")}>
                        <IoChevronBack size={35} />
                    </button>
                    <div>
                        <h1 className="text-3xl font-inter font-medium text-black">Kelola Stock Opname</h1>
            ...
            <div className="bg-card pt-7 pb-9 px-7 shadow-[0_4px_4px_rgba(0,0,0,0.2)]">
                <h2 className="text-2xl font-inter font-medium mb-6">Input Hasil Stock Opname</h2>
...
export default KelolaStockOpnameKaryawan;